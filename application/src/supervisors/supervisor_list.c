...
SupervisorList sup_list = {&se01_liga_cv1, &se01_desliga_cv1_list};
SupervisorList se01_desliga_cv1_list = {&se01_desliga_cv1, &se02_bloqueia_braco_list};
SupervisorList se02_bloqueia_braco_list = {&se02_bloqueia_braco, &se02_desce_braco_list};
SupervisorList se02_desce_braco_list = {&se02_desce_braco, &se02_sobre_braco_list};
SupervisorList se02_sobre_braco_list = {&se02_sobre_braco, &se03_avanca_braco_list};
SupervisorList se03_avanca_braco_list = {&se03_avanca_braco, &se03_retorna_braco_list};
SupervisorList se03_retorna_braco_list = {&se03_retorna_braco, &se04_pega_peca_list};
SupervisorList se04_pega_peca_list = {&se04_pega_peca, &se04_solta_peca_list};
SupervisorList se04_solta_peca_list = {&se04_solta_peca, &se05_liga_cv2_list};
SupervisorList se05_liga_cv2_list = {&se05_liga_cv2, &se05_desliga_cv2_list};
SupervisorList se05_desliga_cv2_list = {&se05_desliga_cv2, NULL};
